...
The following script performs these tasks and requires three input files generated in the scaffolding step; yeast.contigPosInscaff, yeast.scafSeq, yeast.contig.

```
python SOAP_post_process.py <contigPosInScaff_file> <scafSeq_file> <contig_file> <output_file>
